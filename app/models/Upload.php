...
class Upload {
	...
	public function validate(){
		...
		if(!empty($this->tmp) && empty($this->errors)){
			...
			if(array_search($type, $this->allowedFileTypes) === false){
				$this->errors[$this->field] = "Not an allowerd file type. Must be " . implode(', ', array_keys($this->allowedFileTypes));
			}
		}
	...
	public function checkInitialError(){
